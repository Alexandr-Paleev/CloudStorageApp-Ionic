...
| [0004](0004-quota-lives-in-the-database.md)      | The storage quota is enforced by a trigger, not by the API      | unreleased |
| [0005](0005-sentry-loads-when-idle.md)           | Sentry loads after first paint; Session Replay stays off        | unreleased |
